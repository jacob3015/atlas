...
class KrxKospiStockDailyTradingProvider:
    ...
    def read(self, base_date: str) -> pd.DataFrame:
        """Return KOSPI stock daily trading data for a YYYYMMDD base date."""
        self._validate_base_date(base_date)
    ...
    def _to_dataframe(self, payload: Any) -> pd.DataFrame:
        ...
        dataframe["ticker"] = dataframe["ticker"].str.zfill(6)
        dataframe["fluctuation_rate"] = pd.to_numeric(
            dataframe["fluctuation_rate"], errors="coerce"
        )
...
class KrxEtfDailyTradingProvider:
    ...
    FLOAT_COLUMNS = [
        ...
        "underlying_index_fluctuation_rate",
    ]
    ...
    def read(self, base_date: str) -> pd.DataFrame:
        """Return ETF daily trading data for a YYYYMMDD base date."""
        self._validate_base_date(base_date)
